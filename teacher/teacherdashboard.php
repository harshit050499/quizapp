		...
		<div class="col-sm-12 paddoff">
			<div class="col-sm-2 paddoff">
        		...
        		<div class="contain-list">
        			<ul>
        				<li class="active"><i class="fa fa-home" aria-hidden="true"></i><a href="teacherdashboard.php">Dashboard</a></li>
        				<li ><i class="fa fa-users" aria-hidden="true"></i><a href="addstudent.php">Add Student</a></li>
